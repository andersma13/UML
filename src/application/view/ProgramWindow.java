...
public class ProgramWindow extends Stage 
{
		...
		EventHandler<ActionEvent> exportEvent = new EventHandler<ActionEvent> ()
		{
			...
			public void handle(ActionEvent e)
			{
				...
				if(job != null)
				{
					...
					job.getJobSettings().setPageLayout(printer.createPageLayout(
							Paper.NA_LETTER, PageOrientation.LANDSCAPE, 0,0,0,0));
	 ...
	 * 
	 * @param in	The class block to be removed
	 */
	 ...
	 * 
	 * @param in	The link to be removed
	 */
