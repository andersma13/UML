...
public class ClassBlock extends VBox 
{
	 ...
	 * 
	 * @param modelIn The ClassModel object storing the data to be used
	 * 
	 */
	 ...
	 * 
	 * @param attrIn The attributes to be set
	 */
	 ...
	 * 
	 * @param operIn The operations to be set
	 */
	 ...
	 * 
	 * @param descIn The description to be set
	 */
	...
	/**
	 * Updates the ClassBlock's LinkNode with correct height & width, now 
	...
	/**
	 * Panels to be used in the Class Block object.
